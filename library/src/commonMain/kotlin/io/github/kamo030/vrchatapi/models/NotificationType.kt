 ...
 * 
 *
 * Values: FriendRequest,Invite,InviteResponse,Message,RequestInvite,RequestInviteResponse,Votetokick
 */
@Serializable
enum class NotificationType(val value: kotlin.String) {

    @SerialName(value = "friendRequest")
    FriendRequest("friendRequest"),

    @SerialName(value = "invite")
    Invite("invite"),

    @SerialName(value = "inviteResponse")
    InviteResponse("inviteResponse"),

    @SerialName(value = "message")
    Message("message"),

    @SerialName(value = "requestInvite")
    RequestInvite("requestInvite"),

    @SerialName(value = "requestInviteResponse")
    RequestInviteResponse("requestInviteResponse"),

    @SerialName(value = "votetokick")
